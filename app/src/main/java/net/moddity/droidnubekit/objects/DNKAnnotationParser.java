                ...
                try {
                    ...
                    switch (recordField.getType()) {
                        ...
                        case REFERENCE_LIST:
                            ...
                            break;
                        case TIMESTAMP:
                            field.set(newObject, ((Date)recordField.getValue()).getTime());

                            break;
                        case STRING_LIST:
                            List<String> stringList = (ArrayList<String>) recordField.getValue();

                            field.set(newObject, stringList);

                            break;
                        case INT64_LIST:
                            List<Integer> integerList = (ArrayList<Integer>) recordField.getValue();

                            field.set(newObject, integerList);
