...
public class DNKRecordQueryRequest {
    ...
    public void addFilter(String fieldName, Object fieldValueValue, String fieldValueType, String comparator)
    {
        DNKRecordField fieldValue = DNKRecordField.createRecordField(fieldValueValue, fieldValueType);
        DNKFilter filter = DNKFilter.createFilter(fieldName, fieldValue, comparator);
